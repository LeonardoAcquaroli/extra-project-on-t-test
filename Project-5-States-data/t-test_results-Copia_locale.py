...
states = pd.read_excel(r"C:\Users\leoac\OneDrive - Università degli Studi di Milano\Unimi\Subjects\Statistics\Extra project\Project-5-States-data\State_data.xlsx")
